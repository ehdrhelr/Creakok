	...
	<div class="inner">
		...
		<div class="r_list">
				...
				<div class="row">
                    ...
                    <div class="col-md-8">
                    <h2 class="text-center" style="margin-top: 150px; margin-bottom:30px">답글 쓰기</h2>
                    <form name="input" action="board_answer?board_index=${board.board_index}" method="post"/>
                                ...
                                <input type="text" class="form-control" name="member_name" value="${member.member_name}" readonly=""></td></tr>
                                  <tr><td>Email</td><td>
									...
									<tr><td><input type="hidden" name="creator_name" value="${theCreator.creator_name}"></td></tr>                              
                              		<tr><td><input type="hidden" name="board_refer" value="${board.board_refer}"></td></tr>
                              		<tr><td><input type="hidden" name="board_level" value="${board.board_level}"></td></tr>                              		
                              		<tr><td><input type="hidden" name="board_sunbun" value="${board.board_sunbun}"></td></tr>
                              		
                              </tbody>
                         </table>
                         <input type="submit" value="답글작성" class="btn" style="background-color:black !important; color:white">
