                ...
                <div class="col-12">
                    <div class="checkout_details_area clearfix">
                        ...
                        <form action="goods_pay.do" method="post" name="f">
                            <div class="row">
                                ...
                                <div class="col-6 mb-4">
                                    ...
                                    <input type="number" class="form-control" value="" name="phone_number" onkeydown="enterCheck(this)" placeholder="숫자만 입력" required>
                                </div>
						...
						<h5 class="col-12 mb-4" style="margin-top:20px;">배송 정보</h5>
                                ...
                                <div class="col-6 mb-4">
                                    <label for="phone_number">연락처 *</label>
                                    <input type="number" name="delivery_phone" class="form-control" value="" placeholder="숫자만 입력" onkeydown="enterCheck(this)" required>
                                </div>
