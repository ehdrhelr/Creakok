...
import="creakok.com.domain.Member_origin, creakok.com.filesetting.Path"%>
                        ...
                        <c:if test="${!empty order_info}">
                              ...
                              <tr class="orderInfo_detail">
                                 ...
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;border-left:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700">크리에이터 : </span><span>${order_info.buyer_name}</span> 
                                 </td>
                              </tr>
                              <tr class="orderInfo_detail">
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700">펀딩명 : </span><span>${order_info.buyer_phone}</span>
                                 </td>
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;border-left:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700">펀딩 종료일 : </span><span>${order_info.member_email}</span> 
                                 </td>
                              </tr>
                              <tr class="orderInfo_detail"">
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700">펀딩여부 : </span><span>${order_info.buy_date}</span>
                                 </td>
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;border-left:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700">결제예정일 : </span><span>${order_info.buy_addr}</span> 
                                 </td>
                              </tr>
  
                              <tr class="orderInfo_detail">
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;padding:10px">
                                   <span style="font-weight:700"> : </span><span>${order_info.buyer_buyid}</span>
                                 </td>
                                 <td colspan="3" style="font-size:12pt;color:black;text-align:left;border-bottom:1px solid #bdbdbd;border-left:1px solid #bdbdbd;padding:10px">
                			...
                			<p style="text-align:center;margin-top:20px"><a href="member_order.do?member_email=${order_info.member_email}&order_cp=1&order_list_number=${order_info.order_list_number}" style="font-size:13pt;background-color:black; color:white; width:130px; padding:3px;">목록으로</a></p>
                </div>
