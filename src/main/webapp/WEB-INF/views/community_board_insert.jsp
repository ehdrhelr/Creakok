...
<body>
	...
	<div class="inner">
		...
		<div class="r_list">
				<div class="choose">
                <form name="input" action="board_insert" method="post">
                               <table border="1" width="600" align="center" cellpadding="3" cellspacing="1">
                                  <tbody>
                                  <tr>
                                     <td align="center">글제목</td>
                                     <td align="center"><input type="text" name="board_subject" size="60"></td>
                                  </tr>
                                  <tr>
                                     <td align="center">글내용</td>
                                     <td align="center"><textarea name="board_content" rows="5" cols="53" style="width:500px; height:250px;"></textarea></td>
                                  </tr>
                                <tr>
