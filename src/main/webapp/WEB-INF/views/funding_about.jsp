...
<body onload="readFundingLike();">
                            ...
                            <div class="Card-sc-1sgtmvk-0 iZjgMf">
                                ...
                                style="margin:20px">
                                    ...
                                    <div>
							              ...
							              <h3>펀딩 취소 및 결제 안내</h3>
							              <p>펀딩 결제는 예약 상태로 유지되다가, 펀딩 마감일 다음날인 <strong>${aboutpay_date} 
							              </strong>에 모두 함께 진행됩니다. 결제 정보 변경은 결제가 진행되기 전까지 언제나 가능합니다. 참여한 펀딩 정보 변경은 
							                 <c:if test="${!empty member}">
									              <a class="link" href="member_mypage.do?focus=funding&member_email=${member.member_email}&fundingpay_cp=1#my_funding">
									              펀딩 내역</a>
							             	 </c:if>
							             	 <c:if test="${empty member}">
									              <a class="link" href="member_login.do">
									              로그인</a> 후 펀딩 내역
							             	 </c:if>
							              에서 진행해주세요. 
							              마감일 이후에는 해당 크리에이터에게 펀딩 모금이 전달되며, 크리에이터는 프로젝트 제작을 시작하게 됩니다. 
							              취소는 펀딩 마감일 전날인 <strong>${aboutcancel_date}</strong>이후로는 불가합니다.</p>
                        ...
                        <div class="ProjectPage__SubColumnInner-f3cisk-6 qujmm">
                            <div class="Card-sc-1sgtmvk-0 iZjgMf ProjectPage__StyledCreatorCard-f3cisk-5 lfTmkG">
                                <div class="CreatorCard__CreatorCardInner-sc-1ifohey-0 iubrbI">
                                    ...
                                    <div class="CreatorCard__CreatorProfile-sc-1ifohey-2 bnLQVO"><span class="ProfileImg__StyledProfileImg-sc-1vio56c-0 gwsafG"  style="background-image: url(img/community/${creator_profile_photo});"></span>
	...
	<script>
      function goCreator(){
    	  location.href="board_page?creator_name=${funding_detail.creator_name}";
      }
    </script>
