                            ...
                            <div class="Card-sc-1sgtmvk-0 iZjgMf">
                                ...
                                style="margin:20px">
                                    ...
                                    <div>
							              ...
							              </strong>에 모두 함께 진행됩니다. 결제 정보 변경은 결제가 진행되기 전까지 언제나 가능합니다. 참여한 펀딩 정보 변경은 마이페이지 <a class="link" href="member_mypage.do?focus=funding&member_email=${member.member_email}&order_cp=1#my_funding">펀딩 내역</a>에서 진행해주세요. 
