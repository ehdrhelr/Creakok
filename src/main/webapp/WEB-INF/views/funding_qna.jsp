                    ...
                    <aside class="ProjectIntroduction__ProjectIntroductionSubColumn-sc-1o2ojgb-12 fHdIrJ">
                        ...
                        <div class="ProjectIntroduction__ProjectButtons-sc-1o2ojgb-19 fHOYOE">
                            <div class="ProjectIntroduction__ProjectButtonsInner-sc-1o2ojgb-20 jHbICj">
                                ...
                                <div class="ProjectIntroduction__TertiaryButton-sc-1o2ojgb-26 fGephg"><button type="button" class="Button-sc-1x93b2b-0 ProjectIntroduction__ShareSNSButton-sc-1o2ojgb-25 llyixJ funding_share">
                          ...
                          <script>
                            function urlClipCopy() {
                               ...
                               // alert(here);
                                ...
                                $('.funding_share').attr('data-clipboard-text', document.location.href);
                                var clipboard = new Clipboard('.funding_share');
    ...
    <div class="container">
            ...
            <div  style="font-size:10pt;">
                ...
                <table style="">
                    ...
                    <tbody>
                        <c:if test="${empty funding_detail.funding_qnaVo.list}">
                           <td colspan="5">
                                                             문의글이 없습니다.
                           </td>           
                        </c:if>
