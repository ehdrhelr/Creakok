            ...
            <div class="" style="font-size:10pt;">
                ...
                <table style="">
                    ...
                    <tbody>
                                        ...
                                        <td style="padding:1.5px !important;"><a href="#" style="color:black;">${one_review.goods_review_subject}</a></td>
                                    ...
                                    <tr>
                                       <td colspan="6">
                                          ...
                                          <p style="text-align:center;font-size:10pt;color:black;font-size:10pt;">${one_review.goods_review_content}</p> 
