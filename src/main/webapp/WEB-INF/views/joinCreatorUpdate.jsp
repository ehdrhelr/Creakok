...
<body>
    ...
    <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
      <div style="width:750px;" class="Wrapper__MembershipBody-sc-140yq7-0 dgBlAy">
        <form id="creator_joinData" name="creator_joinData" style="color:#757575" method='post' enctype="multipart/form-data" action='updateCreatorJoinData.do'>
          ...
          <div class="SignUp__InputDiv-k5h4n5-0 VpHEi" >
              ...
              <div class="profile_preview">
                <img src="${Path.IMG_STORE_CREATOR}${creator.creator_profile_photo}">
              </div>
          </div>
          ...
          <div class="SignUp__InputDiv-k5h4n5-0 VpHEi" >
              ...
              <div class="banner_preview">
                <img src="${Path.IMG_STORE_CREATOR}${creator.creator_banner_photo}">
              </div>
          </div>
          ...
          <button type="button" class="Button-sc-1x93b2b-0 SignUp__SignUpButton-k5h4n5-2 cWylwi" onclick="updateCreatorJoin();">신청내용 수정하기</button>
        </form>
      </div>
  </div>
