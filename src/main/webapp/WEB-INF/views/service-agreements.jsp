...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="CREAKOK">
  <meta name="application-name" content="CREAKOK">
    <script src="//developers.kakao.com/sdk/js/kakao.min.js"></script>
    <style data-styled="etlKsY QGKgG jOcSCe iSuAdB jDMeTv MskhC fMekoE fbsOED hLwNNy cAHVaf jkgXDu gMdHoi hbKGuE iDsnca cLNJqs iJpZic fWpQcH zoWUI bgEfGq irjBzn deKUvf kgSuxg jiSOCu hwjRMa ieMDUN gFgAyJ gVuNGp gUfPmS ilwNes erxKKA cDdnng bmduJF fpKouC dKBthp" data-styled-version="4.4.1">
...
<body>
  ...
  <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
    <div style="margin-top:180px; margin-bottom:50px" class="Wrapper__MembershipBody-sc-140yq7-0 ServiceAgreements__MembershipBody-sc-192nqvr-5 deKUvf">
      <div class="ServiceAgreements__ContentsBody-sc-192nqvr-0 kgSuxg">
        <h4 class="ServiceAgreements__ServiceAgreementsHeader-sc-192nqvr-1 jiSOCu">아래 내용에 동의해주세요</h4>
        <p class="ServiceAgreements__Guidance-sc-192nqvr-2 hwjRMa">
                원활한 서비스 제공을 위해
        <a href="/terms-of-use" target="_blank">텀블벅 이용약관</a> 및 
        <a href="/privacy" target="_blank">개인정보 수집·이용</a> 등의 내용에 동의해주세요.
        </p>
        <form autoComplete="on" method='post' action='member_signup.do'>
          <div class="_13KHfN73YmQgsYHxXvuh_J _3bQlo02zZkYjUBehiAWUDX ServiceAgreements__ServiceAgreementCheckbox-sc-192nqvr-4 ieMDUN">
            <input type="checkbox" id="f217a" required="" />
            <label for="f217a" style="cursor: pointer">CREAKOK 이용약관에 동의합니다. (필수)</label>
          </div>
          <div
            class="_13KHfN73YmQgsYHxXvuh_J _3bQlo02zZkYjUBehiAWUDX ServiceAgreements__ServiceAgreementCheckbox-sc-192nqvr-4 ieMDUN">
            <input type="checkbox" id="5733" required="" />
            <label for="5733" style="cursor: pointer">개인정보 수집·이용에 동의합니다. (필수)</label>
          </div>
          <div class="_13KHfN73YmQgsYHxXvuh_J _3bQlo02zZkYjUBehiAWUDX ServiceAgreements__ServiceAgreementCheckbox-sc-192nqvr-4 ieMDUN">
            <input type="checkbox" id="a66d" required="" />
            <label for="a66d" style="cursor: pointer">만 14세 이상입니다. (필수)</label>
          </div>
          <input type="hidden" name="member_name" value="${new_member_name}">
          <input type="hidden" name="member_email" value="${new_member_email}">
          <input type="hidden" name="member_password" value="${new_member_password}">
          <button type="submit" class="Button-sc-1x93b2b-0 ServiceAgreements__SubmitButton-sc-192nqvr-3 gFgAyJ">가입하기</button>
        </form>
      </div>
    </div>
  </div>
