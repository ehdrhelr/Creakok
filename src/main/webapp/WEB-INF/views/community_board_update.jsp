...
<body>
   <!-- Preloader -->
    ...
    <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
 					<h3 style="text-align:center;margin-bottom:40px;font-size:18pt">수정하기</h3>
   
          
          
          
	    <div class="submit_a_review_area mt-50" style="width: 60%; margin: auto;" >
	    	<form method="post" action="board_update?board_index=${board.board_index}" onsubmit="return goWrite()">                            
		    <div>
