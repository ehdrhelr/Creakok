...
<body>
   <!-- Preloader -->
    ...
    <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
 					<h3 style="text-align:center;margin-bottom:40px;font-size:18pt">문의글 수정</h3>
   
          
          
          
	    <div class="submit_a_review_area mt-50" style="width: 60%; margin: auto;" >
	    	<form method="post" action="goods_qna_update.do#fix_point" onsubmit="return goWrite()">
		    				      ...
		    				      <div>
                                    ...
                                    <input name="qna_writer" style="display:inline-block;width:30%;margin-right:5%" class="form-control" id="reviewer_name" 
                                        value="${one_qna.member_name}" readonly>
                                    <label for="goods_name">제품명</label>&nbsp;&nbsp;
                                    <input name="goods_name" style="display:inline-block;width:30%" class="form-control" id="goods_name" 
                                        value="${goods_name}" readonly>
                                </div>
                                
                                 <div style="margin-top:10px">
                                    <label for="goods_qna_subject" style="margin-right:2%">제목</label>
                                    <input name="goods_qna_subject" style="display:inline-block;width:90%" class="form-control" id="goods_qna_subject" 
                                    value="${one_qna.goods_qna_subject}" required>
				...
				<br>
				<textarea id="summernote" name="goods_qna_content">${one_qna.goods_qna_content}</textarea>
				
				<p style="width:100%;text-align:center; margin-top:20px;">
    				<input id="subBtn" type="submit" style="padding:3px;background-color:#fc5230;color:white;border:0;border-radius:4px;width:100px" value="수정하기" />
    				<a href="goods_qna.do?review_cp=1&goods_index=${one_qna.goods_index}#fix_point"><input id="subBtn2" type="button"  style="padding:3px;background-color:white;color:#fc5230;border:1px solid #fc5230;border-radius:4px;width:100px" value="목록으로"/></a>
