        ...
        <div id="contentsNavigation">
            <nav class="ContentsNavigation__ProjectContentsNavigation-mwsx7i-1 bmUMcp">
                <div class="ContentsNavigation__ProjectContentsNavigationInner-mwsx7i-2 OvVKa">
                    ...
                    <a class="ContentsNavigation__NavItem-mwsx7i-0 cjInbB"  href="goods_detail.do?goods_index=${qna_list.goods_index}#fix_point">상품상세정보</a>
                         ...
                         <c:forEach items="${qna_list.qna_list}" var="qna_list">
                             <tr>
                                  ...
                                  <td style="padding:1.5px !important;">
                                    <a href="goods_one_qna.do?goods_qna_index=${qna_list.goods_qna_index}&goods_index=${qna_list.goods_index}&qna_list_number=${qna_list.qna_list_number}#fix_point" >
