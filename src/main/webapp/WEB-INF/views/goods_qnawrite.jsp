...
<body>
   <!-- Preloader -->
    ...
    <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
 					<h3 style="text-align:center;margin-bottom:40px;font-size:18pt">문의글 쓰기</h3>
   
          
          
          
	    <div class="submit_a_review_area mt-50" style="width: 60%; margin: auto;" >
	    	<form method="post" action="goods_qna_insert.do#fix_point" onsubmit="return goWrite()">
                                 ...
                                 <div style="margin-top:10px">
                                    <label for="qna_subject" style="margin-right:2%">제목</label>
                                    <input name="qna_subject" style="display:inline-block;width:90%" class="form-control" id="qna_subject" 
                                    placeholder="제목" value="" required>
                                   <input type="hidden" name="goods_index" value="${one_goods.goods_index}"/>
                                   <input type="hidden" name="creator_name" value="${one_goods.creator_name}"/>
                                </div>
				...
				<p style="width:100%;text-align:center; margin-top:20px;">
    				...
    				<a href="goods_qna.do?qna_cp=1&goods_index=${one_goods.goods_index}#fix_point"><input id="subBtn2" type="button"  style="padding:3px;background-color:white;color:#fc5230;border:1px solid #fc5230;border-radius:4px;width:100px" value="목록으로"/></a>
