    ...
    <div class="Membership__MembershipWrapper-o1o1he-0 irjBzn">
	    ...
	    <div class="submit_a_review_area mt-50" style="width: 60%; margin: auto;" >
	    	<form method="post" action="goods_review_insert.do">
				...
				<input id="subBtn2" type="reset"  style="padding:3px;background-color:white;color:#fc5230;border:1px solid #fc5230;border-radius:4px;width:100px"value="목록으로" onclick="goWrite(this.form)"/>
				</p>			 		
			</form>
		</div>
    </div>
